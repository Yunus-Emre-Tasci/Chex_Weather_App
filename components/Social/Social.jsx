...
const Social = () => {
  return (
    <div className="hidden lg:flex fixed flex-col top-[45%] left-0 z-10">
      <ul>
        <li className="w-[145px] h-[60px] flex justify-between items-center ml-[-110px] hover:ml-[-33px] duration-300 bg-blue-600">
          <a
        ...
        <li className="w-[145px] h-[60px] flex justify-between items-center ml-[-110px] hover:ml-[-33px] duration-300 bg-[#333333]">
          <a
            className="flex px-3 justify-between items-center w-full text-gray-300 hover:text-gray-300"
